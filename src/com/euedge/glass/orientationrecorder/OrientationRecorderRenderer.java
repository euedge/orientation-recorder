 ...
 * {@link SensorsOrientationManager}) so that tracking only occurs when the card is visible.
 */
public class OrientationRecorderRenderer implements SurfaceHolder.Callback {

    private static final String TAG = OrientationRecorderRenderer.class.getSimpleName();
    ...
    private final OrientationRecorderView mOrientationManagerView;
    private final RelativeLayout mTipsContainer;
    private final TextView mTipsView;
    private OrientationManager mOrientationManager;

    private final OrientationManager.OnChangedListener mOrientationListener =
            new OrientationManager.OnChangedListener() {

        @Override
        public void onOrientationChanged(OrientationManager orientationManager) {
            mOrientationManagerView.setHeading(orientationManager.getHeading());
        ...
        public void onLocationChanged(OrientationManager orientationManager) {
            mOrientationManagerView.setSpeed(orientationManager.getLocation().getSpeed());
        }
     ...
     */
    public OrientationRecorderRenderer(Context context, OrientationManager orientationManager) {
        LayoutInflater inflater = LayoutInflater.from(context);
        mLayout = (FrameLayout) inflater.inflate(R.layout.orientation_recorder, null);
        mLayout.setWillNotDraw(false);

        mOrientationManagerView = (OrientationRecorderView) mLayout.findViewById(R.id.orientation_recorder_view);
        ...
        mOrientationManagerView.setOrientationManager(mOrientationManager);
    }
    
    public void setOrientationManager(OrientationManager om) {
        mOrientationManager.removeOnChangedListener(mOrientationListener);
        
        mOrientationManager = om;
        mOrientationManager.addOnChangedListener(mOrientationListener);
        mOrientationManagerView.setOrientationManager(mOrientationManager);
    }
    ...
    public void setUom(int uom) {
        mOrientationManagerView.setUom(uom);
    }

    public int getUom() {
        return mOrientationManagerView.getUom();
    }
